...
class IPCBagRecorder : public rclcpp::Node {
   public:
    IPCBagRecorder(const rclcpp::NodeOptions& options) : Node("ipc_bag_recorder", options) {
        ...
        this->declare_parameter<std::vector<std::string>>("topic_types",
                                                          std::vector<std::string>());
        ...
        for (size_t i = 0; i < topic_names_.size(); i++) {
            RCLCPP_INFO(this->get_logger(), "topic_name: %s, type: %s", topic_names_[i].c_str(),
                        topic_types_[i].c_str());
        }
        ...
        rosbag2_storage::StorageOptions storage_options = {
            bag_file_, storage_id_, (uint64_t)max_bag_size_, (uint64_t)max_bag_duration_};
        ...
        for (size_t i = 0; i < topic_names_.size(); ++i) {
            ...
            if (topic_type == "sensor_msgs/msg/PointCloud2") {
                ...
                pc_subscriptions_[topic_name] =
                    create_subscription<sensor_msgs::msg::PointCloud2>(topic_name, 10, callback);
                ...
                rgb_subscriptions_[topic_name] =
                    create_subscription<sensor_msgs::msg::Image>(topic_name, 10, callback);
                ...
                camera_info_subscriptions_[topic_name] =
                    create_subscription<sensor_msgs::msg::CameraInfo>(topic_name, 10, callback);
                ...
                odometry_subscriptions_[topic_name] =
                    create_subscription<nav_msgs::msg::Odometry>(topic_name, 10, callback);
                ...
                nav_sat_fix_subscriptions_[topic_name] =
                    create_subscription<sensor_msgs::msg::NavSatFix>(topic_name, 10, callback);
                ...
                pose_stamped_subscriptions_[topic_name] =
                    create_subscription<geometry_msgs::msg::PoseStamped>(topic_name, 10, callback);
                ...
                if (topic_name == "/tf_static") {
                    ...
                    tf_subscriptions_[topic_name] = create_subscription<tf2_msgs::msg::TFMessage>(
                        topic_name, qos_tf_static, callback, sub_options);
   ...
   private:
    void pc_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg,
        ...
        rclcpp::Time record_time(std::max(start_time_.nanoseconds(), time_stamp.nanoseconds()));
        writer_->write(serialized_msg, topic_name, "sensor_msgs/msg/PointCloud2", record_time);
    }
    ...
    void rgb_callback(const sensor_msgs::msg::Image::SharedPtr msg,
        ...
        rclcpp::Time time_stamp = msg->header.stamp;
        rclcpp::Time record_time(std::max(start_time_.nanoseconds(), time_stamp.nanoseconds()));
        writer_->write(serialized_msg, topic_name, "sensor_msgs/msg/Image", record_time);
    }
    ...
    void camera_info_callback(const sensor_msgs::msg::CameraInfo::SharedPtr msg,
        ...
        rclcpp::Time time_stamp = msg->header.stamp;
        rclcpp::Time record_time(std::max(start_time_.nanoseconds(), time_stamp.nanoseconds()));
        writer_->write(serialized_msg, topic_name, "sensor_msgs/msg/CameraInfo", record_time);
    }
    ...
    void odometry_callback(const nav_msgs::msg::Odometry::SharedPtr msg,
        ...
        rclcpp::Time time_stamp = msg->header.stamp;
        rclcpp::Time record_time(std::max(start_time_.nanoseconds(), time_stamp.nanoseconds()));
        writer_->write(serialized_msg, topic_name, "nav_msgs/msg/Odometry", record_time);
    }
    ...
    void nav_sat_fix_callback(const sensor_msgs::msg::NavSatFix::SharedPtr msg,
        ...
        rclcpp::Time time_stamp = msg->header.stamp;
        rclcpp::Time record_time(std::max(start_time_.nanoseconds(), time_stamp.nanoseconds()));
        writer_->write(serialized_msg, topic_name, "sensor_msgs/msg/NavSatFix", record_time);
    }
    ...
    void pose_stamped_callback(const geometry_msgs::msg::PoseStamped::SharedPtr msg,
        ...
        rclcpp::Time time_stamp = msg->header.stamp;
        rclcpp::Time record_time(std::max(start_time_.nanoseconds(), time_stamp.nanoseconds()));
        writer_->write(serialized_msg, topic_name, "geometry_msgs/msg/PoseStamped", record_time);
    }
    ...
    void tf_callback(const tf2_msgs::msg::TFMessage::SharedPtr msg,
        ...
        rclcpp::Time record_time(std::max(start_time_.nanoseconds(), time_stamp.nanoseconds()));
        writer_->write(serialized_msg, topic_name, "tf2_msgs/msg/TFMessage", record_time);
    }
    ...
    std::unordered_map<std::string, rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr>
        odometry_subscriptions_;
    std::unordered_map<std::string, rclcpp::Subscription<sensor_msgs::msg::NavSatFix>::SharedPtr>
        nav_sat_fix_subscriptions_;
    std::unordered_map<std::string,
                       rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr>
        pose_stamped_subscriptions_;
    std::unordered_map<std::string, rclcpp::Subscription<tf2_msgs::msg::TFMessage>::SharedPtr>
        tf_subscriptions_;
